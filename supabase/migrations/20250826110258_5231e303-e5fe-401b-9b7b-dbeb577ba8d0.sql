...
-- Reservations (simplified without complex constraint)
...
-- Enable RLS on all tables with simple policies for now
...
-- Simple RLS Policies - authenticated users get full access for MVP
CREATE POLICY "auth_full_access" ON profiles FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON dining_tables FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON service_windows FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON reservations FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON employees FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON shifts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON shift_requirements FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON suppliers FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON items FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON stock_movements FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON purchase_orders FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON po_line_items FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON forecasts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON alerts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON social_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON posts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON post_comments FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON review_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON reviews FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON pos_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON pos_sales_cache FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON job_schedules FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON jobs FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON automation_rules FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON webhook_endpoints FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON outbox FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "auth_full_access" ON audit_logs FOR ALL USING (auth.uid() IS NOT NULL);
