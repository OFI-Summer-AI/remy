...
CREATE UNIQUE INDEX uq_jobs_idem ON jobs(idempotency_key) WHERE idempotency_key IS NOT NULL;
...
-- Simple RLS Policies - authenticated users get full access for now
CREATE POLICY "Authenticated users full access" ON profiles FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON dining_tables FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON service_windows FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON reservations FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON employees FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON shifts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON shift_requirements FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON suppliers FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON items FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON stock_movements FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON purchase_orders FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON po_line_items FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON forecasts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON alerts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON social_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON posts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON post_comments FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON review_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON reviews FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON pos_accounts FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON pos_sales_cache FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON job_schedules FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON jobs FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON automation_rules FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON webhook_endpoints FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON outbox FOR ALL USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users full access" ON audit_logs FOR ALL USING (auth.uid() IS NOT NULL);
