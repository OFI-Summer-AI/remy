...
-- Helper function to get user role (now immutable)
...
-- Basic RLS Policies (simplified to avoid recursive function calls)
CREATE POLICY "Users full access to own profile" ON profiles
  FOR ALL USING (auth.uid() = id);

CREATE POLICY "Public read access to dining_tables" ON dining_tables
  FOR SELECT USING (true);

CREATE POLICY "Authenticated users can manage dining_tables" ON dining_tables
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Public read access to service_windows" ON service_windows
  FOR SELECT USING (true);

CREATE POLICY "Authenticated users can manage service_windows" ON service_windows
  FOR ALL USING (auth.uid() IS NOT NULL);
...
CREATE POLICY "Authenticated users can manage shift_requirements" ON shift_requirements
  FOR ALL USING (auth.uid() IS NOT NULL);
...
CREATE POLICY "Authenticated users can manage po_line_items" ON po_line_items
  FOR ALL USING (auth.uid() IS NOT NULL);
...
CREATE POLICY "Authenticated users can manage social_accounts" ON social_accounts
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage posts" ON posts
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage post_comments" ON post_comments
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage review_accounts" ON review_accounts
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage reviews" ON reviews
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage pos_accounts" ON pos_accounts
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage pos_sales_cache" ON pos_sales_cache
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage job_schedules" ON job_schedules
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can view jobs" ON jobs
  FOR SELECT USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage automation_rules" ON automation_rules
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage webhook_endpoints" ON webhook_endpoints
  FOR ALL USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can manage outbox" ON outbox
  FOR ALL USING (auth.uid() IS NOT NULL);
